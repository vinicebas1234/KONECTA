  ...
  "node_modules/@mediapipe/hands/hands.js"(exports) {
    (function() {
      ...
      function Wa(a) {
        ...
        else if (Ua) a = BigInt(a), G = Number(a & BigInt(4294967295)) >>> 0, H = Number(a >> BigInt(32) & BigInt(4294967295));
        else {
          var b = +("-" === a[0]);
          H = G = 0;
      ...
      function bc(a, b, c) {
        if (c) {
          ...
          for (e in c) {
            var g = c[e], f = g.qa;
            f || (d.J = g.wa || g.oa.W, g.ia ? (d.aa = cc(g.ia), f = /* @__PURE__ */ (function(h) {
      ...
      function jc(a) {
        var b = a.ia;
        if (b) return gc(b);
        if (b = a.va) return fc(a.da.P, b, a.ka);
      }
      function kc(a) {
      ...
      var Y = Ac(function(a, b, c) {
        ...
        if (null != b) {
          ...
          a = a.h;
          var d = +b;
          0 === d ? 0 < 1 / d ? G = H = 0 : (H = 0, G = 2147483648) : isNaN(d) ? (H = 0, G = 2147483647) : (d = (c = 0 > d ? -2147483648 : 0) ? -d : d, 34028234663852886e22 < d ? (H = 0, G = (c | 2139095040) >>> 0) : 11754943508222875e-54 > d ? (d = Math.round(d / Math.pow(2, -149)), H = 0, G = (c | d) >>> 0) : (b = Math.floor(Math.log(d) / Math.LN2), d *= Math.pow(2, -b), d = Math.round(8388608 * d), 16777216 <= d && ++b, H = 0, G = (c | b + 127 << 23 | d & 8388607) >>> 0));
          c = G;
          a.h.push(c >>> 0 & 255);
          a.h.push(c >>> 8 & 255);
          a.h.push(c >>> 16 & 255);
      ...
      function Uc(a) {
        return Ob(a, Z, 1).map(function(b) {
          var c = S(b, 1);
          return { index: null == c ? 0 : c, score: W(b, 2), label: null != S(b, 3) ? Rb(S(b, 3), "") : void 0, displayName: null != S(b, 4) ? Rb(S(b, 4), "") : void 0 };
        });
      }
      ;
      function Vc(a) {
        return { x: W(a, 1), y: W(a, 2), z: W(a, 3), visibility: null != Mb(a, 4) ? W(a, 4) : void 0 };
      }
      function Wc(a) {
        return a.map(function(b) {
          return Ob(Pc(b), Lc, 1).map(Vc);
        });
      }
      ;
      function Xc(a, b) {
      ...
      function Zc(a, b) {
        ...
        if (void 0 === a.s) {
          ...
          a.l = { O: c.getAttribLocation(d, "aVertex"), N: c.getAttribLocation(d, "aTex"), xa: e };
          a.v = c.createBuffer();
                  ...
                  switch (k.type) {
                    ...
                    case "detections":
                      ...
                      for (w = 0; w < n.length; ++w) {
                        ...
                        if (t.ba) for (v = 0; v < t.ba.length; ++v) B = q.data, J = B.addClassification, I = w, u = t.ba[v], C = new Z(), V(C, 2, u.score), u.index && U(C, 1, u.index), u.label && U(C, 3, u.label), u.displayName && U(C, 4, u.displayName), u = C.l(), J.call(B, I, u);
                      }
                      q = q.data;
                      break a;
                    default:
              ...
              if ("detection_list" === r.type) {
                if (p) {
                  ...
                  for (var J = p.getLandmarksList(), I = p.getClassificationsList(), u = [], C = 0; C < B.size(); ++C) {
                    var T = Sc(B.get(C)), pd = W(T, 1), qd = W(T, 2), rd = W(T, 3), sd = W(T, 4), td = W(T, 5, 0), Aa = void 0;
                    Aa = void 0 === Aa ? 0 : Aa;
                    T = { la: { ra: pd, sa: qd, height: rd, width: sd, rotation: td, pa: Rb(S(T, 6), Aa) }, ea: Ob(Pc(J.get(C)), Lc, 1).map(Vc), ba: Uc(Kc(I.get(C))) };
                    u.push(T);
                  }
                  B = u;
                } else B = [];
      ...
      function od(a) {
        ...
        this.h = new fd({ locateFile: a.locateFile, files: function(c) {
          return [{ url: "hands_solution_packed_assets_loader.js" }, { simd: false, url: "hands_solution_wasm_bin.js" }, { simd: true, url: "hands_solution_simd_wasm_bin.js" }, { data: true, url: nd(c.modelComplexity) }];
          ...
          onChange: function(c) {
            var d, e, g;
            return E(function(f) {
              if (1 == f.h) return d = nd(c), e = "third_party/mediapipe/modules/hand_landmark/" + d, D(f, hd(b.h, d), 2);
              g = f.i;
...
export default require_hands();
//# sourceMappingURL=@mediapipe_hands.js.map
