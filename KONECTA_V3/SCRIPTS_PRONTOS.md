# 🤖 Scripts Prontos para Colar - KONECTA Agents

Copie e cole cada script abaixo no Orca
...
2. Abrir Orca (Ctrl+Shift+W)
3. Create worktree
4. Colar no campo "Name or Create From"
5. Click "Create worktree"
6. Pronto! Agent começa a trabalhar

**8 agents, 8 scripts prontos!** 🚀
